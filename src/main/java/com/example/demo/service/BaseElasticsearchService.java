...
public abstract class BaseElasticsearchService {
    ...
    protected static IndexRequest buildIndexRequest(String index, String id, Object object) {
        return new IndexRequest(index).id(id).source(JSONObject.parseObject(JSON.toJSONString(object), Map.class));
    }
    ...
    protected void updateRequest(String index, String id, Object object) {
        try {
            UpdateRequest updateRequest = new UpdateRequest(index, id).doc(JSONObject.parseObject(JSON.toJSONString(object), Map.class));
